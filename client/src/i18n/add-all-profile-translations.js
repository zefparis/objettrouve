...
// Traductions complètes pour les pages de profil
...
LANGUAGES.forEach(lang => {
  ...
  try {
    ...
    if (translations) {
      existing.profilePage = translations;
      
      fs.writeFileSync(filePath, JSON.stringify(existing, null, 2));
      console.log(`✅ ${lang.toUpperCase()}: Section profilePage ajoutée avec succès`);
    }
  } catch (error) {
...
console.log('\n🎉 Toutes les traductions de profil ont été ajoutées avec succès!');